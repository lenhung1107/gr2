...
export const loginUser= async(user, dispatch, callback)=>{
    dispatch(loginStart());
    try{
        const res = await axios.post("https://gr2-hdy0.onrender.com/auth/login",user,{
...
export const registerUser= async(user, dispatch)=>{
    ...
    try{
        const res = await axios.post("https://gr2-hdy0.onrender.com/auth/signup",user,{
            withCredentials: true
        });
...
export const deleteUser=async(accessToken, dispatch, id) =>{
    ...
    try{
        const res= await axios.delete("https://gr2-hdy0.onrender.com/adminpage/"+id,{
...
export const logOut= async(dispatch, id,navigate,accessToken,axiosJWT)=>{
    ...
    try{
        ...
        await axiosJWT.post("https://gr2-hdy0.onrender.com/auth/logout",id,{
             headers:{token: `Bearer ${accessToken}`}
        });
