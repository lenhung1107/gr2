  ...
  const dummyHistoryData = [
    {
      ...
      prescription: [
        { medicine: "Paracetamol", dosage: "500mg", instructions: "Uống 1 viên sau ăn, ngày 2 lần" },
        { medicine: "Vitamin B1", dosage: "250mg", instructions: "Uống 1 viên mỗi sáng" }
      ]
    },
    {
      ...
      prescription: [
        { medicine: "Amoxicillin", dosage: "500mg", instructions: "Uống 1 viên mỗi 8 giờ" },
        { medicine: "Acemuc", dosage: "200mg", instructions: "Hòa tan với nước, uống sau ăn" }
      ]
    }
  ];
