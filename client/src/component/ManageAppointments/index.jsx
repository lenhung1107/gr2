...
function ManageAppointments() {
  const apiUrl = "https://gr2-3t8u.onrender.com/appointment/getAllAppoinment";
  ...
  const confirmCancel = async () => {
    ...
    const reason = document.getElementById('reason').value;
      const response = await fetch(
        `https://gr2-3t8u.onrender.com/appointment/cancelByAdmin/${selectedAppointment._id}`,
        {
          method: "PUT",
          headers: {
  ...
  const handleConfirmAppointment = async (appointment) => {
    try {
      const response = await fetch(
        `https://gr2-3t8u.onrender.com/appointment/confirmByAdmin/${appointment._id}`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
