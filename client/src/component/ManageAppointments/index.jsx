...
function ManageAppointments() {
    const apiUrl = "https://gr2-3t8u.onrender.com/appointment/getAllAppoinment"; // URL API khác cho từng trang
    ...
    const handleConfirmAppointment = async (appointment) => {
        try {
            const response = await fetch(`https://gr2-3t8u.onrender.com/appointment/confirmByAdmin/${appointment._id}`, {
                method: 'PUT',
                headers: {
